...
if uselua:
    ...
    # build the luamongo driver bson-related functions statically for now.
    scriptingFiles += [ "src/third-party/luamongo/mongo_bsontypes.cpp", "src/third-party/luamongo/utils.cpp" ]
