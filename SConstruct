...
add_option( "uselua" , "support lua scripts" , 0 , True )
...
if ( not ( usesm or usev8 or uselua or justClientLib) ):
    usesm = True
...
if uselua:
    ...
    env.Prepend( CPPPATH=["/Users/ben/devel/third_party/lua/src/"] )
    env.Prepend( LIBPATH=["/Users/ben/devel/third_party/lua/src/"] )
